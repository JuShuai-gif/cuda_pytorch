...
# ============================================================
# TensorMap — 张量映射（SignatureDef 中逻辑名称到实际张量索引的映射）
# ============================================================
...
# ============================================================
# FlatBuffer 根节点解析入口
# 从内存中的 FlatBuffer 二进制数据中解析出 TensorMap 表
# 调用方式: obj = TensorMap.GetRootAsTensorMap(buf, offset)
#   - buf: bytes 类型，整个 FlatBuffer 二进制数据
#   - offset: 起始偏移量（通常为 0）
# TfliteConvertor.loadTFmodel() 通过 TensorMap.GetRootAsTensorMap(buf, 0) 调用
# ============================================================
    @classmethod
...
# 字段不存在时返回 None
    ...
    # TensorMap
# 读取 TensorIndex 字段（uint32（无符号32位整数））
# 子图中的张量索引
