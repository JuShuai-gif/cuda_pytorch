...
# ============================================================
# Metadata — 元数据条目（键值对，附加到模型上的额外信息）
# ============================================================
...
# ============================================================
# FlatBuffer 根节点解析入口
# 从内存中的 FlatBuffer 二进制数据中解析出 Metadata 表
# 调用方式: obj = Metadata.GetRootAsMetadata(buf, offset)
#   - buf: bytes 类型，整个 FlatBuffer 二进制数据
#   - offset: 起始偏移量（通常为 0）
# TfliteConvertor.loadTFmodel() 通过 Metadata.GetRootAsMetadata(buf, 0) 调用
# ============================================================
    @classmethod
...
# 将 Table 访问器绑定到 buf 的 pos 位置
    ...
    # Metadata
# 读取 Name 字段（字符串类型）
# 元数据名称（字符串），如 'min_runtime_version'
# vtable 偏移量: 4
    def Name(self):
