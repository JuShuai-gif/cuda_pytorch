...
constexpr int MLA_QK_NOPE_HEAD_DIM = 128;
constexpr int MLA_QK_ROPE_HEAD_DIM = 64;
...
__global__ void ConcatMLQKKernel(DType *__restrict__ k, const DType *__restrict__ k_nope,
    ...
    constexpr int HEAD_CHUNK_SIZE = MLA_HEAD_CHUNK_SIZE : constexpr int NUM_HEAD_CHUNKS = MLA_NUM_HEAD_CHUNKS;
    ...
    int *__restrict__ rope_dst = reinterpret_cast<int *>(k + token_id * k_stride_0 + head_row0 * k_stride_1 + QK_NOPE_HEAD_DIM) + lane_id;
