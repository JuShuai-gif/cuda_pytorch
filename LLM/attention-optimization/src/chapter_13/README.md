...
This chapter contains the runnable artifacts for `Quantized Attention`. The implementation is intentionally educational: it favors explicit data movement, small reproducible examples, and clear metrics over maximum performance. Production caveats are documented in `notes/chapter_13.md`.

## Files

- `quantized_attention.cpp` - main implementation or reading guide.
...
```bash
ncu --set full ./chapters/quantized_attention
nsys profile -o chapter_13_timeline ./chapters/quantized_attention
```
