...
This chapter contains the runnable artifacts for `Sparse Attention`. The implementation is intentionally educational: it favors explicit data movement, small reproducible examples, and clear metrics over maximum performance. Production caveats are documented in `notes/chapter_11.md`.

## Files

- `block_sparse_attention.cpp` - main implementation or reading guide.
...
```bash
ncu --set full ./chapters/block_sparse_attention
nsys profile -o chapter_11_timeline ./chapters/block_sparse_attention
```
