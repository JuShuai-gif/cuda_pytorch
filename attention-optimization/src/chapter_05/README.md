...
This chapter contains the runnable artifacts for `FlashAttention V2`. The implementation is intentionally educational: it favors explicit data movement, small reproducible examples, and clear metrics over maximum performance. Production caveats are documented in `notes/chapter_05.md`.

## Files

- `flash_attention_v2.cu` - main implementation or reading guide.
...
```bash
ncu --set full ./chapters/flash_attention_v2
nsys profile -o chapter_05_timeline ./chapters/flash_attention_v2
```
