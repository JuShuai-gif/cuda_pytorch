...
This chapter contains the runnable artifacts for `Linear Attention`. The implementation is intentionally educational: it favors explicit data movement, small reproducible examples, and clear metrics over maximum performance. Production caveats are documented in `notes/chapter_12.md`.

## Files

- `linear_attention.cpp` - main implementation or reading guide.
...
```bash
ncu --set full ./chapters/linear_attention
nsys profile -o chapter_12_timeline ./chapters/linear_attention
```
